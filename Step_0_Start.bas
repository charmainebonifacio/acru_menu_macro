...
Sub Start_Here()
    ...
    button1 = "PARAMETERIZE MENU FILE"
    frameLabel2 = "TOOL GUIDE"
    frameLabel3 = "HELP SECTION"
    
    strLabel1 = "THE ACRU MENU PARAMETERIZATION MACRO   "
    strLabel2 = "STEP 1."
    strLabel3 = "Check DEFINITION page. Then, proceed to manually calibrate values in MENU_PARAM page." & vbLf
    strLabel4 = "STEP 3."
    strLabel5 = "For more information, hover mouse over button."
    strLabel7 = "STEP 2."
    strLabel8 = "Enter a short summary for each calibration." & vbLf
...
Function HELPFILE(ByVal Notification As Integer) As String
    ...
    Select Case Notification
        Case 1
            ...
            NotifyUser = NotifyUser & "DESCRIPTION: This macro will save the most current " & _
                "worksheet that contains 23 variables and then run the Fortran program to " & _
                "automatically adjust the variables within MENU file." & vbLf
            NotifyUser = NotifyUser & "INPUT: MENU and MENU_PARAM.txt" & vbLf
            NotifyUser = NotifyUser & "OUTPUT: LOG_RUN file, MENU, MENU_OLD, MENU_PARAM.txt and MENU_PARAM_OLD.txt" & vbLf
    End Select
